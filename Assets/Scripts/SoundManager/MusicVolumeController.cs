...
{
    [Header("Slider de Música (opcional)")]
    [SerializeField] private Slider slider;

    [Header("Prefs")]
    [SerializeField] private string prefsKey = "MUSIC_VOLUME"; // clave única
    ...
    {
        // Escala global de música: podés usar AudioListener o un AudioSource de fondo
